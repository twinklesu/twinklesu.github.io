...
![첫 화면](https://raw.githubusercontent.com/twinklesu/twinklesu.github.io/master/_image/KakaoTalk_20200810_225436244.png)
 ...
 &nbsp&nbsp&nbsp&nbsp[Oven](https://ovenapp.io/)

링크로 이동하면 이런 화면이 뜬다. Kakao API인데,, 굴림체인 것도 그렇고 말투도, 디자인도 상당히 해외 프로그램을 이용하는 기분이 든다. 베타라 그런가...? 
구글로 간단히 회원가입 할 수 있다.

![유형 선택](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_225735451.png)
이메일 인증만으로 스탠다드로 무료 업그레이드를 할 수 있다. 차이는 이용할 수 있는 이미지 용량 정도? 

![프로젝트 생성](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_225755669.png)
회원 가입 후 우측 상단에서 **새로운 프로젝트 만들기**를 누르면 만드려는 UI의 크기를 설정할 수 있다.

## 디자인하기
![빈 페이지](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_231405034.png)
간단하고 깔끔하게 생겼다. 그냥 보이는 대로 왼쪽에서 페이지를 추가하고, 페이지 복제, 이름 변경 등이 가능하다. 오른쪽에 기본으로 준비 된 UI 요소가 있다. 

![예시](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_231415367.png)
...
![링크](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_231811796.png)
...
![자랑!](https://github.com/twinklesu/twinklesu.github.io/blob/master/_image/KakaoTalk_20200810_231502216.png)
